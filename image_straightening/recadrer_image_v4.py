...
def save_images_as_pdf(images, output_pdf_path):
    ...
    print(f"PDF corrigé enregistré sous : {output_pdf_path}")


pdf_path = r'D:/GitHub/HOCR/image_straightening/mortstatsh_1921.pdf'
output_pdf_path = r'D:/GitHub/HOCR/image_straightening/mortstatsh_1921_output.pdf' 
...
save_images_as_pdf(corrected_images, output_pdf_path)