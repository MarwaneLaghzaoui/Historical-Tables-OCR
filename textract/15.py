...
pdf_path = r'D:\EISTI\Pfe\textract\test_pages.pdf'
...
def traitement_page(indice):
    ...
    detection_colonnes_noires(binary_image, 200, 40, tolerance= 5)
    
    detection_lignes_noires(binary_image, 200, 100, tolerance = 5)
    
    
    if(colonne_noire_positions[1]- colonne_noire_positions[0] > 300) :
        ...
        #print(lignes_noires_colonne_gauche)
        global lignes_noires_colonne_gauche_save
        lignes_noires_colonne_gauche_save = [x - ligne_noire_positions[2] for x in lignes_noires_colonne_gauche]
        #print(lignes_noires_colonne_gauche_save)
        ...
        lignes_noires_colonne_gauche = [x + ligne_noire_positions[2] for x in lignes_noires_colonne_gauche_save]
        
        image_etendue = inserer_lignes_decalees(binary_image, colonne_noire_positions[0], colonne_blanche, lignes_noires_colonne_gauche)
        ...
        plt.imsave("test2.pdf", image_etendue, cmap='gray')
